...
public:
     ...
     *
     * \a mode The mode of the dialog.
     * \a displayMode The mode of displaying: full or vcard
     * \a parent The parent widget of the dialog.
     * \since 4.10
     */
    ...
    /*!
     * Sets the \a contact to edit when in EditMode.
     * \a contact the contact to edit
     * \note The contact item just must have a uid set, all
     * other data are fetched by the dialog automatically.
     */
    void setContact(const Akonadi::Item &contact);

    /*!
     * Sets the \a addressbook that shall be selected as default in create mode.
     */
...
Q_SIGNALS:
     ...
     *
     * \a contact The data reference of the contact.
     */
     ...
     *
     * \a errMsg The error during updating or storing contact.
     */
